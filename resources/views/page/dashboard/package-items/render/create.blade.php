...
<form action="{{ route('dashboard.package-items.store') }}" method="post" class="ajax_form" data-after-submit="reload"
    enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="package_id" id="package_id" value="{{ request()->get('package_id') }}">
    ...
    <div class="tab-content mb-4" id="languageTabContent">
        <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="numeric" class="form-control" name="minimum_order" id="minimum_order" placeholder="Enter Minimum Order">
                </div>
            </div>
        </div>
        <div class="tab-pane fade" id="indonesian" role="tabpanel" aria-labelledby="indonesian-tab">
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="text" class="form-control" name="name_id" id="name_id" placeholder="Masukkan Nama">
                </div>
            </div>
