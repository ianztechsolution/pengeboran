                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-sm btn-light ajax_modal_btn" title="Paket Barang"
                                data-modal-title="Paket Barang - {{ $item->name_id }}" data-modal-size="lg"
                            ...
                            <button type="button" class="btn btn-sm btn-light ajax_modal_btn" title="Detail"
                                data-modal-title="Detail Paket" data-modal-size="lg"
                            ...
                            <button type="button" class="btn btn-sm btn-light ajax_modal_btn" title="Edit"
                                data-modal-title="Edit Paket" data-modal-size="lg"
