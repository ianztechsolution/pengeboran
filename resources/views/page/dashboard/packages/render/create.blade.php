...
<form action="{{ route('dashboard.packages.store') }}" method="post" class="ajax_form" data-after-submit="reload"
    enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="packageble_type" id="packageble_type" value="{{ $packageble_type }}">
    <input type="hidden" name="packageble_id" id="packageble_id" value="{{ request()->get('packageble_id') }}">
    ...
    <div class="tab-content mb-4" id="languageTabContent">
        <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <textarea class="form-control" name="detail_en" id="detail_en" placeholder="Enter Text"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="text" class="form-control" name="name_id" id="name_id" placeholder="Masukkan Nama Paket">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <textarea class="form-control" name="detail_id" id="detail_id" placeholder="Masukkan Isi"></textarea>
                </div>
            </div>
        </div>
    </div>
