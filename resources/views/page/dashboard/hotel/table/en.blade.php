        ...
        <tbody>
            @foreach ($hotels as $item)
                <tr>
                    ...
                    <td>{{ $item->settings->business_name ?? 'name has not been set' }}</td>
                    <td>{{ $item->settings->business_phone ?? 'phone has not been set'}} </td>
                    <td>{{ Str::limit($item->settings->business_address ?? 'address has not been set', 30)}}</td>
                    <td>
