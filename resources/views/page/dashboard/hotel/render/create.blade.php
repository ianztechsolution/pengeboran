<form action="{{ route('dashboard.hotel.store') }}" method="post" class="ajax_form" data-after-submit="reload"
    ...
    <div class="row mb-3">
        ...
        <div class="col-12 col-lg-8">
            <input type="email" class="form-control" name="business_email" id="business_email" placeholder="Enter business email">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-12 col-lg-8">
            <input type="number" class="form-control" name="business_phone" id="business_phone" placeholder="Enter business phone">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-12 col-lg-8">
            <textarea class="form-control" name="business_address" id="business_address" placeholder="Enter business address"></textarea>
        </div>
    </div>
