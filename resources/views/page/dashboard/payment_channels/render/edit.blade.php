            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xxl-12">
                        ...
                        @endif
                        <form action="{{ route('dashboard.master-data.payment-channels.update', $payment_channel->id) }}" method="post" class="ajax_form" data-after-submit="reload"
                        enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="name" class="form-label">Nama <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan Nama" required="" value="{{ $payment_channel->name }}">
                            </div>
                            <div class="mb-3">
                                <label for="description-field" class="form-label">Deskripsi</label>
                                <textarea name="description" id="description-field" class="form-control" placeholder="Masukkan Deskripsi">{!! $payment_channel->description !!}</textarea>
                            </div>
                            <div class="mb-3">
