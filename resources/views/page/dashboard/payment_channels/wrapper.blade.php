            ...
            <div class="col-xxl-12">
                <div class="card" id="patientsList">
                    ...
                    <div class="card-body">
                        <div class="row mb-2 d-flex justify-content-between align-items-center">
                            <div class="col-sm-12 col-md-6 d-flex justify-content-start">
                                <button type="button" class="btn btn-success add-btn ajax_modal_btn" title="Add" data-modal-title="Tambah Jenis Layanan"
                                    data-modal-size="lg" data-render-route="{{ route('dashboard.master-data.payment-channels.create') }}" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i></button>
                            </div>
                        ...
                        @include('page.dashboard.payment_channels.render.create')
                        @include('page.dashboard.payment_channels.table.id')
                    </div>
                </div>
            </div>
        </div>
