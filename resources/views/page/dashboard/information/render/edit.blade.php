...
<form action="{{ route('dashboard.information.update', $information->id) }}" method="post" class="ajax_form"
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <select class="form-select" name="availability" id="availability">
                        <option value="available" {{ $information->availability == 'available' ? 'selected' : '' }}>
                            Available</option>
                        <option value="inavailable" {{ $information->availability == 'inavailable' ? 'selected' : '' }}>
                            Unavailable</option>
                    </select>
                </div>
            </div>
