...
@section('content')
    <div class="d-lg-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <button type="button" class="btn btn_theme ajax_modal_btn" title="Add" data-modal-title="Add Category"
                data-modal-size="lg" data-render-route="{{ route('dashboard.categories.create') }}?type={{ $type }}">
    ...
    <div class="card bg_transparent_1">
        <div class="card-body">
            @if (config('app.locale') === 'en')
                @include('page.dashboard.categories.table.en')
            @elseif (config('app.locale') === 'id')
                @include('page.dashboard.categories.table.id')
            @endif
        </div>
