...
<form action="{{ route('dashboard.categories.update', $category->id) }}" method="post" class="ajax_form" data-after-submit="reload"
    ...
    <div class="tab-content mb-4" id="languageTabContent">
        <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                        ...
                        <div class="row row-cols-2 row-cols-lg-4">
                            <div class="col mb-3">
                                <div class="image_delete_button"
                                    data-route="{{ route('image.destroy-single-file', ['model' => class_basename($category), 'column' => 'image_icon', 'object_id' => $category->id]) }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="text" class="form-control" name="title_en" id="title_en" placeholder="Enter title" value="{{ $category->title_en }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="text" class="form-control" name="short_description_en" id="short_description_en"
                        placeholder="Enter short description" value="{{ $category->short_description_en }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <textarea class="form-control" name="description_en" id="description_en" placeholder="Enter description">{{ $category->description_en }}</textarea>
                </div>
            </div>
        </div>
        <div class="tab-pane fade" id="indonesian" role="tabpanel" aria-labelledby="indonesian-tab">
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="text" class="form-control" name="title_id" id="title_id"
                        placeholder="Masukkan judul" value="{{ $category->title_id }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="text" class="form-control" name="short_description_id" id="short_description_id"
                        placeholder="Masukkan deskripsi singkat" value="{{ $category->short_description_id }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <textarea class="form-control" name="description_id" id="description_id" placeholder="Masukkan deskripsi">{{ $category->description_id }}</textarea>
                </div>
            </div>
        </div>
    </div>
