...
<form action="{{ route('dashboard.restaurants.store') }}" method="post" class="ajax_form" data-after-submit="reload"
    ...
    <div class="tab-content mb-4" id="languageTabContent">
        <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-lg-8">
                        <input type="text" class="form-control" name="name_en" id="name_en" placeholder="Enter title">
                    </div>
                </div>
        ...
        <div class="tab-pane fade" id="indonesian" role="tabpanel" aria-labelledby="indonesian-tab">
            <div class="row mb-3">
                ...
                <div class="col-12 col-lg-8">
                    <input type="file" class="form-control" accept="image/*" name="image_id[]" id="image_en[]" multiple>
                </div>
            </div>

            <div class="row mb-3">
                <div class="col-12 col-lg-4 mb-1">
                    <label for="name_id">Judul</label>
                </div>
                <div class="col-12 col-lg-8">
